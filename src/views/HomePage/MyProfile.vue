            ...
            <div class="w-full mt-8">
                ...
                <div class="mt-4">
                            ...
                            <div class="flex-1">
                                ...
                                <div class="text-sm">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <BaseInputField v-model="tempValue" class="w-96 border border-gray-300 rounded px-2 py-1"/>
                                        <Icon icon="mdi:pencil" class="text-gray-500 hover:text-blue-500 cursor-pointer" @click="editField()" />
                                    </div>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        ...
                                        <div class="flex space-x-4 mt-3">
                                            <BaseRadioButton v-for="option in ['Male', 'Female', 'Others']"  :key="option"  :name="'gender'"  :label="option"  :value="option"  v-model="profile.gender" class="text-sm"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div v-if="activeTab === 'My Purchase'" class="tab-content">
                        ...
                        <div v-if="isshowChatModal" class="fixed bottom-4 right-4 w-[900px] h-[85vh] bg-white rounded-lg shadow-lg flex flex-col border z-50">
                            <!-- Header -->
                                        ...
                                        <div class="flex-1 bg-gray-50 p-4 overflow-auto space-y-4 text-sm">
                                            <div v-for="(message, index) in chatMessages" :key="index"  class="flex items-start space-x-3"  :class="{'justify-end': message.sender === 'You', 'justify-start': message.sender !== 'You'}">
                                                ...
                                                <div class="p-3 rounded-lg shadow-md w-auto max-w-xs" :class="{'bg-green-500 text-white': message.sender === 'You', 'bg-gray-200 text-black': message.sender !== 'You'}">
                                                    <p class="text-sm font-bold" :class="{'text-white': message.sender === 'You', 'text-green-600': message.sender !== 'You'}"> {{ message.sender }}</p>
                                                    <p class="text-xs"> {{ message.text }} </p>
                                                    <p class="text-xs mt-1 text-black">{{ message.time }}</p>
                                                </div>
                                        ...
                                        <div>
                                            <div class="mt-4 flex items-center justify-between">
                                                ...
                                                <div class="flex space-x-2">
                                                    <button class="px-3 py-1 text-sm font-semibold text-green-700 border border-green-600 rounded hover:bg-green-50" @click="openshowChatModal">
                                                        Contact Seller
                                                    </button>
                                                    <button class="px-3 py-1 text-sm font-semibold text-red-600 border border-red-500 rounded hover:bg-red-50"
                                                        @click="openshowCancelModal">
                                                        Cancel Order
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Cancel Order Modal -->
                                            <div v-if="isshowCancelModal"
                                                class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                                <div class="bg-white p-7 rounded-lg shadow-lg w-[500px]">
                                                    <div class="text-end">
                                            ...
                                            <!-- Confirmation Modal -->
                                            <div v-if="isConfirmationModalVisible"
                                                class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                                                <div class="bg-white p-7 rounded-lg shadow-lg w-[400px]">
                                                    <div class="text-end">
                                                    ...
                                                    <div class="mt-4 border rounded-md p-3 shadow space-y-4">
                                                        <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div v-if="isConfirmationModalVisible"
                                                ...
                                                <div class="bg-white p-7 rounded-lg shadow-lg w-[400px]">
                                                    ...
                                                    <div class="border-2 rounded-md p-3 shadow">
                                                        <h2 class="text-center text-lg font-semibold">Refund Details</h2>
                                                    </div>
                                                    <div class="mt-4 border-4 rounded-md p-3 shadow space-y-4">
                                                        <div class="flex items-center gap-3">
                                                            <img src="https://via.placeholder.com/50" alt="Product" class="w-12 h-12 rounded-md">
                                                            <div>
                                                                <p class="font-semibold">Banana</p>
                                    ...
                                    <div class="mt-4 bg-green-100 border border-green-300 rounded-lg p-4">
                                        ...
                                        <div class="mt-4 flex items-center justify-between">
                                            ...
                                            <div class="flex space-x-2">
                                                ...
                                                <button class="px-3 py-1 text-sm font-semibold text-red-600 border border-red-500 rounded hover:bg-red-50" @click="openTrackModal">
                                                    Track Order
                                                </button>
                                            </div>
                                            <div v-if="isshowTrackModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-4">
                                                <div class="bg-white p-7 rounded-lg shadow-lg w-[90vw] max-h-[90vh] flex flex-row relative">
                                                            ...
                                                            <div class="flex w-full items-center">
                                                                <div v-for="(step, index) in steps" :key="index" class="flex items-center w-full">
                                                                    ...
                                                                    <div class="flex flex-col items-center">
                                                                        <div class="w-14 h-14 flex items-center justify-center rounded-full border-2" :class="step.completed ? 'bg-green-300 text-white border-green-500' : 'bg-gray-200 text-gray-500 border-gray-300'">
                                                                            <Icon :icon="step.icon" class="text-xl" />
                                                                        </div>
                                                                    <span class="text-xs text-center mt-2" :class="step.completed ? 'text-green-600' : 'text-gray-400'">
                                                                        {{ step.label }}
                                                                    </span>
                                                                    </div>

                                                                    <!-- Connector Line -->
                                                                    <div v-if="index < steps.length - 1" class="flex-grow h-1" :class="steps[index + 1].completed ? 'bg-green-500' : 'bg-gray-300'"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="w-1/3 p-4 bg-green-100 rounded-lg flex flex-col items-center">
                                        ...
                                        <div>
                                            ...
                                            <div class="mt-4 flex items-center justify-between">
                                               <div class="flex items-center gap-3">
                                                ...
                                                <div class="flex space-x-2">
                                                    <button class="px-3 py-1 text-sm font-semibold text-green-700 border border-green-600 rounded hover:bg-green-50" @click="openRateModal">
                                                        Rate
                                                    </button>
                                                    <button class="px-3 py-1 text-sm font-semibold text-red-600 border border-red-500 rounded hover:bg-red-50" @click="openRefundModal">
                                                        Request Return
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Rate Modal-->
                                            <div v-if="isshowRateModal" class="fixed inset-0 z-50 bg-black bg-opacity-50 flex justify-center items-center">
                                                <div class="bg-white rounded-lg p-6 w-96 relative">
                                                    ...
                                                    <div class="bg-green-700 text-white p-4 rounded-lg flex items-center gap-3 mt-4">
                                                        <img :src="product" alt="Product Image" class="w-14 h-14 rounded-md" />
                                                        <div>
                                                            <p class="font-bold">{{  }}</p>
                                                            <p class="text-sm">Variants: {{ }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="mt-4 flex items-center space-x-2">
                                                        ...
                                                        <span v-for="index in 5" :key="index" @click="rateProduct(index)" class="cursor-pointer text-xl">
                                                            <span v-if="index <= rating" class="text-yellow-500">★</span>
                                                            <span v-else class="text-gray-300">★</span>
                                                        </span>
                                                        </div> -->
                                                    </div>
                                                    <textarea v-model="review" class="w-full p-3 mt-3 border rounded-md text-sm" placeholder="Share your thoughts on the product to help other buyers"></textarea>
                                                    <button @click="submitReview" class="w-full bg-green-700 hover:bg-green-500 text-white py-2 mt-4 rounded-lg font-semibold">Submit</button>
                                                </div>
                                            </div>


                                            <!-- Refund modal-->
                                            <div v-if="isshowRefundModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-">
                                                <div class="bg-white p-5 rounded-lg w-full max-w-3xl h-auto relative flex flex-col md:flex-row gap-6">
                                                    <button @click="closeRefundModal" class="absolute top-3 right-2 text-gray-400 hover:text-gray-600">
                                                        <Icon icon="icon-park-solid:close-one" width="20" height="20" />
                                                    </button>
                                                    
                                                    <!-- Left Column (Product Info & Uploads) -->
                                                    <div class="w-full md:w-1/2 flex flex-col">
                                                        <div class="flex items-start gap-4">
                                                            <img :src="productImage" alt="Product Image" class="w-20 h-20 object-cover rounded" />
                                                            <div>
                                                                <p class="font-semibold">{{ productName }}</p>
                                                                <p class="text-sm text-gray-600">Variants: {{ productVariant }}</p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="mt-1">
                                                            <BaseLabel class=" font-medium">*Reason:</BaseLabel>
                                                            <BaseSelectField v-model="reason" class="w-full mt-1 p-2 border rounded">
                                                        ...
                                                        <div class="mt-3">
                                                        <BaseLabel class=" font-medium">*Description:</BaseLabel>
                                                        <textarea v-model="description" class="text-xs w-full mt-1 p-2 border rounded resize-none h-20"
                                                            placeholder="Leave your comment here (optional)" maxlength="2000"></textarea>
                                                        </div>

                                                        <hr class="my-2 border-t-1 border-gray-500" />

                                                        <div class="mt-2 text-xs text-gray-600">
                                                            *Clear photo/video showing the parcel received and product(s) contained would be mandatory for this request
                                                        </div>
                                                    ...
                                                    <!-- Right Column (Solution & Refund Details) -->
                                                    <div class="w-full md:w-1/2 flex flex-col">
                                                        <div class="mt-3">
                                                            <BaseLabel class=" font-medium">Solution:</BaseLabel>
                                                            <BaseSelectField v-model="solution" class="w-full mt-1 p-2 border rounded">
                                                        ...
                                                        <hr class="my-3 border-t-1 border-gray-500" />

                                                        <div class="mt-2 text-xs">
                                                            <BaseLabel class=" font-medium">Refund amount:</BaseLabel>
                                                            <p class="text-gray-700">{{ refundAmount }}</p>
                                                            <hr class="my-1 border-t-1 border-gray-500" />
                                                            <BaseLabel class="font-medium">Choose return method</BaseLabel>
                                                            <BaseRadioButton v-for="option in ['Pick Up', 'Drop - off']" :key="option" :name="'tinIdOption'" :label="option" :value="option" v-model="tinIdSelected"></BaseRadioButton>
                                                        </div>

                                                        <hr class="my-1 border-t-1 border-gray-500" />

                                                        <div class="mt-2">
                                                            <BaseLabel class=" font-medium">Payment Method:</BaseLabel>
                                                            <button class="border px-4 py-2 mt-1 text-sm w-full hover:bg-gray-50">Gcash</button>
                                                        </div>

                                                        <div class="mt-2">
                                                            <BaseLabel class=" font-medium">Email address</BaseLabel>
                                                            <BaseInputField type="text" v-model="emailaddress" class="w-full mt-1 p-2 text-sm border rounded" />
                                                        </div>
                                                        
                                                        <div class="mt-3 flex justify-center text-sm">
                                                            <button @click="submitRefundRequest" class="bg-green-600 text-white border py-2 px-6 rounded hover:bg-green-500">
                                                                Confirm
                                                            </button>
                                                        </div>
                                                    </div>
