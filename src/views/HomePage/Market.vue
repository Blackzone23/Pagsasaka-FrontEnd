<template>
    <div>
        ...
        <div class="h-full w-full p-10">
            ...
            <div v-if="isshowChatModal" class="fixed bottom-4 right-4 2xl:w-[900px] xs:w-[450px] 2xs:w-[410px] 2xl:h-[85vh] 2xs:h-[70vh] bg-white rounded-lg shadow-lg flex flex-col border z-50">
                <!-- Header -->
