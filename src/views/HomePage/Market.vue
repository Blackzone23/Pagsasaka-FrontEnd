<template>
    <div>
        ...
        <div class="h-full w-full p-10">
            ...
            <div v-if="isshowChatModal" class="fixed bottom-4 right-4 2xl:w-[900px] 2xs:w-[450px] 2xl:h-[85vh] 2xs:h-[70vh] bg-white rounded-lg shadow-lg flex flex-col border z-50">
                <!-- Header -->
              ...
              <div class="flex flex-1 overflow-hidden">
                    ...
                    <div class="w-1/3 bg-white border-r border-gray-300 p-4 flex flex-col">
                        <div class="flex">
                        <BaseSearchField placeholder="Search..." class="2xl:w-[270px] 2xs:w-[129px]   "></BaseSearchField>
                        </div>
