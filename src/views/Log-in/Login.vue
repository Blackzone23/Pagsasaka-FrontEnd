                    ...
                    <div class="2xl:w-1/2 2xs:w-[700px] 2xl:p-8 2xs:p-1 md:p-4 bg-white border-gray-200 border-2">
                        ...
                        <form>
                            ...
                            <div class="mb-4">
                                ...
                                <BaseInputField placeholder="Phone number / Username / Email"></BaseInputField>
                                <BaseError></BaseError>
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <div class="relative">
                                    <BaseInputField :type="isPasswordVisible ? 'text' : 'password'" v-model="password" class="w-full" placeholder="Password"></BaseInputField>

                                    <span @click="togglePasswordVisibility" class="absolute right-3 top-1/2 transform -translate-y-1/2 cursor-pointer">
                                        <Icon :icon="isPasswordVisible ? 'bi:eye-slash' : 'bi:eye'" class="text-gray-500"></Icon>
                                    </span>
