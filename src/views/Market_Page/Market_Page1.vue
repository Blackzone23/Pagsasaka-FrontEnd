<template>
        <div>
            <Market_NavBar/>
            <div class="p-5">
                <div class="flex h-full w-full border-2 border-gray-300 p-5 rounded-md">
                    <!-- Left Side: Picture -->
                    <div class="w-1/2 flex justify-center mt-12">
                        <img :src="MVegetable" alt="Placeholder Image" class="rounded-lg shadow-lg h-[400px] w-[600px]">
                    </div>

                    <!-- Right Side: Text -->
                    <div class="w-1/2 items-center mt-5 ">
                    <BaseLabel class="text-4xl font-bold">Salad package</BaseLabel>
                        <div class="flex items-center mt-2">
                            ...
                            <Icon icon="mdi:star" class="w-6 h-6 text-yellow-400" />
                            <Icon icon="mdi:star" class="w-6 h-6 text-yellow-400" />
                            <Icon icon="mdi:star-outline" class="w-6 h-6 text-gray-400" />
                            
                            <!-- Rating Value -->
                            <span class="ml-2 text-xs text-black">(4.0)</span>
                        </div>
                        <div class="mt-2 text-xs">
                            <p class="text-lg font-semibold text-black">₱390</p>
                            ...
                            <div class="space-y-3 mt-1">
                                ...
                                <div class="flex space-x-4 text-lg">
                                    <h2>Shipping To:</h2>
                                    <span class="font-semibold">{{ shippingData.to }}</span>
                                </div>
                                <div class="flex space-x-4  text-lg">
                                    <h2>Shipping Fee:</h2>
                                    <span class="font-semibold">{{ shippingData.fee }}</span>
                                </div>
                                <div class="flex space-x-4  text-lg">
                                    <h2>Weight:</h2>
                                    <span class="font-semibold">{{ shippingData.weight }}</span>
                                </div>
                                <BaseLabel class="font-poppins font-bold">Min Order Quantity 1 KG</BaseLabel>
                                <div class="flex space-x-4  text-lg">
                                    <h2>Stock:</h2>
                                    <span class="font-semibold">{{ shippingData.stock }}</span>
                                </div>
                                ...
                                <div class="flex items-center space-x-4 mt-2">
                                   ...
                                   <div class="flex items-center border border-gray-300 rounded-full p-1">
                                        <button
                                            class="bg-[#608C54] hover:bg-gray-300 text-white font-bold py-1 px-2 rounded-full" @click="decreaseQuantity">-
                                        </button>
                                        <span class="font-bold mx-4">{{ quantity }}</span>
                                        <button
                                            class="bg-[#608C54] hover:bg-gray-300 text-white font-bold py-1 px-2 rounded-full" @click="increaseQuantity">+
                                        </button>  
                                   </div>
                                </div>
